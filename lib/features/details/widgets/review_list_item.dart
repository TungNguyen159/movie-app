...
import 'package:movie_app/models/reviews.dart';
                                    ...
                                    builder: (ctx, snapshot) {
                                      ...
                                      return Row(
                                        children: [
                                          CircleAvatar(
                                            radius: 16,
                                            backgroundImage: (datas.imageuser ==
                                                        null ||
                                                    datas.imageuser!.isEmpty)
                                                ? const AssetImage(
                                                        "assets/no_image.png")
                                                    as ImageProvider
                                                : NetworkImage(datas.imageuser!),
                                          ),
